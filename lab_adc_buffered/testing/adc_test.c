...
static void assert_cycles_computed(int expected_cycles, int tolerance)
{
    ...
    zassert_true(wait_for_event(ADC_CYCLES_COMPUTED_NOTICE, 5000),
        "ADC_CYCLES_COMPUTED_NOTICE never fired (timeout %d ms)", 5000);
...
ZTEST(diff_adc_tests, test_p2_01_sample_button_triggers_acquisition)
{
    ...
    zassert_true(wait_for_event(ADC_SAMPLE_COMPLETE_NOTICE, 5000), "ADC_SAMPLE_COMPLETE_NOTICE never fired");
...
ZTEST(diff_adc_tests, test_p2_04_returns_to_idle_after_sample)
{
    ...
    zassert_true(wait_for_event(ADC_CYCLES_COMPUTED_NOTICE, 5000), "Acquisition never completed");
